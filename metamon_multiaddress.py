...
if __name__ == "__main__":
    addr1 = ""  # If you have more than one address, you can add your addresses by youself, like addr1, addr2, addr3... and add them in addr list.
    addr2 = ""
    addr = [addr1, addr2]
    ...
    number = [0, 0] # This is the number that you want to open eggs. Its length must be consistent with the addr list, sign list and msg list.
    ...
    for i in range(len(addr)):
        ...
        my_metamon.openMonsterEgg(number=number[i]) # You can change the number, the default is max number which you can compose. Uncomment will unlock the opening eggs function.
        my_metamon.check()
